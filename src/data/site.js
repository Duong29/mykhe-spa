...
export const site = {
  ...
  address: '402 Võ Nguyên Giáp, Ngũ Hành Sơn, Đà Nẵng 550000',
  mapEmbed:
  ...
  // Đánh giá Google — cập nhật số liệu thật khi có
  google: {
    rating: 4.9,
    count: 486,
  ...
  social: {
    ...
    messenger: 'https://m.me/danangmykhespa',
    kakao: 'https://pf.kakao.com/_yourchannel',
    instagram: 'https://instagram.com/danangmykhespa',
  },

  // Kênh nhận đơn đặt lịch của lễ tân (chưa có phần mềm quản lý riêng)
  booking: {
    telegramBot: 'https://t.me/danangmykhespa',
    receptionEmail: 'booking@danangmykhespa.com',
  },
}
